...
func testTokenRoleCreate(t *testing.T, b *meilisearchBackend, s logical.Storage, name string, d map[string]interface{}) (*logical.Response, error) {
	t.Helper()
...
func testTokenRoleUpdate(t *testing.T, b *meilisearchBackend, s logical.Storage, d map[string]interface{}) (*logical.Response, error) {
	t.Helper()
	resp, err := b.HandleRequest(context.Background(), &logical.Request{
...
func testTokenRoleRead(t *testing.T, b *meilisearchBackend, s logical.Storage) (*logical.Response, error) {
	t.Helper()
...
func testTokenRoleList(t *testing.T, b *meilisearchBackend, s logical.Storage) (*logical.Response, error) {
	t.Helper()
	return b.HandleRequest(context.Background(), &logical.Request{
...
func testTokenRoleDelete(t *testing.T, b *meilisearchBackend, s logical.Storage) (*logical.Response, error) {
	t.Helper()
	return b.HandleRequest(context.Background(), &logical.Request{
